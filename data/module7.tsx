...
const TransactProContext = (
  <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100 text-sm text-indigo-900 mb-4">
    <h4 className="font-bold mb-2">TransactPro Cost Analysis</h4>
    <ul className="list-disc list-inside">
        <li>Fixed Costs: £600,000/year</li>
        <li>Variable Cost: £0.15/transaction</li>
        <li>Price: £0.50/transaction</li>
    </ul>
  </div>
);
