...
const CaseStudyContext = (
  <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100 text-sm text-indigo-900 mb-4">
    <h4 className="font-bold mb-2">GlobalPay Ltd — Due Diligence</h4>
    <div className="grid grid-cols-2 gap-4">
        <div>
            <strong>Year 2 Stats:</strong>
            <ul className="list-disc list-inside">
                <li>TPV: £650M</li>
                <li>Net Rev: £4.9M</li>
                <li>Op Expenses: £2.5M</li>
                <li>Net Income: £0.2M</li>
            </ul>
        </div>
        <div>
            <strong>Cash Flow:</strong>
            <ul className="list-disc list-inside">
                <li>Op Cash Flow: £0.3M</li>
                <li>CAPEX: (£0.7M)</li>
                <li>Receivables: Up 80%</li>
            </ul>
        </div>
    </div>
  </div>
