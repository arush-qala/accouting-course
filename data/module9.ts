...
const PayFlowContext = React.createElement("div", { className: "bg-indigo-50 p-4 rounded-lg border border-indigo-100 text-sm text-indigo-900 mb-4" },
    React.createElement("h4", { className: "font-bold mb-2" }, "PayFlow Analytics — Q4 Variance"),
    React.createElement("div", { className: "grid grid-cols-3 gap-2" },
        React.createElement("div", { className: "font-bold" }, "Metric"), React.createElement("div", { className: "font-bold" }, "Budget"), React.createElement("div", { className: "font-bold" }, "Actual"),
        React.createElement("div", null, "Transactions"), React.createElement("div", null, "100,000"), React.createElement("div", null, "112,000"),
        React.createElement("div", null, "Rev / Trans"), React.createElement("div", null, "£2.00"), React.createElement("div", null, "£1.85"),
        React.createElement("div", null, "Var Cost / Trans"), React.createElement("div", null, "£0.80"), React.createElement("div", null, "£0.85"),
        React.createElement("div", null, "Fixed Costs"), React.createElement("div", null, "£80,000"), React.createElement("div", null, "£82,000")
    )
);
